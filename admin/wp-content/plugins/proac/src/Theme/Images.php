...
class Images{
    ...
    protected function generate_srcset ($imagestyle, $attachement_id){
        ...
        switch($imagestyle){
            ...
            case 'page-half':
                    foreach( ['page-half','page-standard','page-small'] as $size){
                        $output[] = $this->srcset($size, $attachement_id);
                    }
            case 'thumbnail':
    ...
    public function after_theme_setup(){
        ...
        add_image_size( 'header', 1240, 234, true );
        add_image_size( 'full-width', 1240, 9999, false );
        add_image_size( 'page-half', 510, 9999, false );
        add_image_size( 'page-small', 330, 9999, false );
    }
